...
public class MapWriter
{
    ...
    /// <param name="baseFilePath">La ruta de archivo base.</param>
    ...
    public void WriteMapFile(SortedSet<KeyOffset> keyOffsets, string baseFilePath)
    {
        ...
        {
            throw new ArgumentNullException(nameof(baseFilePath), "La ruta de archivo base no puede ser null.");
        }

        // Construir la ruta de archivo completa añadiendo la extensión ".mp"
